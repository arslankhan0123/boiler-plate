...
Route::prefix('v1')->middleware(['auth:api', 'tenant.init', 'tenant.required'])->group(function (): void {
    Route::prefix('pos')->name('pos.')->group(function (): void {
        ...
        Route::post('terminals', [PosController::class, 'storeTerminal']);
        Route::post('shifts/open', [PosController::class, 'openShift']);
        Route::post('shifts/{shift}/close', [PosController::class, 'closeShift']);
        Route::get('sales', [PosController::class, 'sales']);
        Route::post('sales', [PosController::class, 'checkout']);
        Route::get('sales/{sale}', [PosController::class, 'showSale']);
    });
});
