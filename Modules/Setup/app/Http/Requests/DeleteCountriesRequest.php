...
/**
 * Delete payload is a bare array of ids: `[1, 2, 3]` (soft delete).
 *
 ...
 */
class DeleteCountriesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'ids' => ['required', 'array'],
            'ids.*' => ['integer', Rule::exists(Country::class, 'id')->whereNull('deleted_at')],
        ];
    }
