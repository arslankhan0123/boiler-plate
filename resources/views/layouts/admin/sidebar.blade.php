<aside class="orchid-sidebar" id="orchidSidebar" aria-label="Primary navigation">
    ...
    <nav class="orchid-sidebar__nav" aria-label="Main">
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                <li>
                    <a href="#navDashboard" class="orchid-nav__link orchid-nav__link--has-sub trail-active"
                        data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="navDashboard">
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                ...
                <li><a href="leave-management.html" class="orchid-nav__link"><i class="bi bi-calendar-x"></i><span>Leave
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                ...
                <li><a href="email.html" class="orchid-nav__link"><i class="bi bi-envelope"></i><span>Email</span></a>
                </li>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                <li><a href="{{ route('users.index') }}" class="orchid-nav__link"><i
                ...
                <li><a href="user-activity.html" class="orchid-nav__link"><i class="bi bi-activity"></i><span>User
                            Activity</span></a></li>
                <li><a href="login-history.html" class="orchid-nav__link"><i class="bi bi-clock-history"></i><span>Login
                            History</span></a></li>
            </ul>
        </div>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                ...
                <li><a href="knowledge-base.html" class="orchid-nav__link"><i class="bi bi-book"></i><span>Knowledge
                            Base</span></a></li>
                <li><a href="todo.html" class="orchid-nav__link"><i class="bi bi-list-check"></i><span>To-Do</span></a>
                </li>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                <li><a href="settings.html" class="orchid-nav__link"><i class="bi bi-gear"></i><span>Settings</span></a>
                </li>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                ...
                <li><a href="ui-badges.html" class="orchid-nav__link"><i class="bi bi-award"></i><span>Badges</span></a>
                </li>
                <li><a href="ui-buttons.html" class="orchid-nav__link"><i class="bi bi-app"></i><span>Buttons</span></a>
                </li>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                <li><a href="forms-basic.html" class="orchid-nav__link"><i class="bi bi-input-cursor"></i><span>Basic
                            Forms</span></a></li>
                ...
                <li><a href="forms-editor.html" class="orchid-nav__link"><i class="bi bi-textarea-t"></i><span>Rich Text
                            Editor</span></a></li>
                ...
                <li><a href="forms-timepicker.html" class="orchid-nav__link"><i class="bi bi-clock"></i><span>Time
                            Picker</span></a></li>
                <li><a href="forms-colorpicker.html" class="orchid-nav__link"><i class="bi bi-palette"></i><span>Color
                            Picker</span></a></li>
            </ul>
        </div>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                ...
                <li><a href="tables-advanced.html" class="orchid-nav__link"><i class="bi bi-grid-3x3"></i><span>Advanced
                            Table</span></a></li>
            </ul>
        </div>
        ...
        <div class="orchid-nav-section">
            ...
            <ul class="orchid-nav">
                ...
                <li><a href="icons-fontawesome.html" class="orchid-nav__link"><i class="bi bi-star-fill"></i><span>Font
                            Awesome</span></a></li>
