                                ...
                                <ul class="orchid-task-list list-unstyled mb-0">
                                    <li class="orchid-task-list__item">
                                        <div class="form-check">
                                            ...
                                            <label
                                                class="form-check-label text-decoration-line-through text-body-secondary"
                        ...
                        <div class="card orchid-card h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-3 small">
                                    <div><span class="orchid-dot bg-primary"></span> Won <strong
                                            class="ms-1">28</strong></div>
                                    <div><span class="orchid-dot bg-warning"></span> Pending <strong
                                            class="ms-1">14</strong></div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Revenue range">
                                        <input type="radio" class="btn-check" name="revRange" id="revW"
                                            autocomplete="off">
                                        <label class="btn btn-outline-secondary" for="revW">W</label>
                                        <input type="radio" class="btn-check" name="revRange" id="revM"
                                            autocomplete="off" checked>
                                        <label class="btn btn-outline-secondary" for="revM">M</label>
                                        <input type="radio" class="btn-check" name="revRange" id="revY"
                                            autocomplete="off">
                                ...
                                <div class="row g-3">
                                    <div class="col-6 col-md-4 col-xl-2">
                                        <div class="orchid-pipeline">
                                            ...
                                            <div class="progress orchid-pipeline__bar" role="progressbar"
                                                aria-label="Leads" aria-valuenow="85" aria-valuemin="0"
                                                aria-valuemax="100">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-2">
                                        <div class="orchid-pipeline">
                                            ...
                                            <div class="progress orchid-pipeline__bar" role="progressbar"
                                                aria-label="Qualified" aria-valuenow="70" aria-valuemin="0"
                                                aria-valuemax="100">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-2">
                                        <div class="orchid-pipeline">
                                            ...
                                            <div class="progress orchid-pipeline__bar" role="progressbar"
                                                aria-label="Proposal" aria-valuenow="60" aria-valuemin="0"
                                                aria-valuemax="100">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-2">
                                        <div class="orchid-pipeline">
                                            ...
                                            <div class="progress orchid-pipeline__bar" role="progressbar"
                                                aria-label="Negotiation" aria-valuenow="45" aria-valuemin="0"
                                                aria-valuemax="100">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-2">
                                        <div class="orchid-pipeline">
                                            ...
                                            <div class="progress orchid-pipeline__bar" role="progressbar"
                                                aria-label="Won" aria-valuenow="92" aria-valuemin="0"
                                                aria-valuemax="100">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-2">
                                        <div class="orchid-pipeline">
                                            ...
                                            <div class="progress orchid-pipeline__bar" role="progressbar"
                                                aria-label="Lost" aria-valuenow="18" aria-valuemin="0"
                                                aria-valuemax="100">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-body-secondary d-md-none">emma@nova.io</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-body-secondary d-md-none">james@acme.com</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-body-secondary d-md-none">sarah@zen.co</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-body-secondary d-md-none">ryan@peak.io</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-body-secondary d-md-none">ava@bold.co</small>
                                                        </div>
                                                    </div>
                                                </td>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="orchid-timeline list-unstyled mb-0">
                                    ...
                                    <li class="orchid-timeline__item">
                                        ...
                                        <div>
                                            <p class="mb-0"><strong>Sarah Miller</strong> added a comment on <a
                                                    href="#">Q2 Roadmap</a></p>
                                    ...
                                    <li class="orchid-timeline__item">
                                        ...
                                        <div>
                                            <p class="mb-0"><strong>Ava Lee</strong> shared the file <a
                                                    href="#">Brand.pdf</a></p>
